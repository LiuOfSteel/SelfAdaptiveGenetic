...
public class Exercise6 {
    ...
    static int algorithm = 0;               // the parameter choose to execute different algorithms 0: mutation and crossover together, 1: randomly mutation or crossover, 2: choose operation based on history.
    ...
    public static void main(String[] args) throws IOException {
        ...
        for(int i = 0; i < bestSolutionsSet.getFirst().order.length; i++){
            System.out.print("    " + i + " " + bestSolutionsSet.getFirst().order[i][0]);
        }
